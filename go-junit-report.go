...
var (
	...
	forceOutput   = flag.Bool("force-output", false, "contain system output in report")
)
...
func main() {
	...
	// Write xml
	err = formatter.JUnitReportXML(report, *noXMLHeader, *forceOutput, *goVersionFlag, os.Stdout)
	if err != nil {
